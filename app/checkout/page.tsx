...
export default function CheckoutPage() {
  ...
  const { items, checkoutId, isLoading } = useAppSelector(
    (state) => state.cart
  );
    ...
    if (checkoutId) {
      await dispatch(
        updateShippingAddress({
          checkoutId,
          shippingAddress: { ...data, country: "IN" },
        })
      );
      setCurrentStep(2);
    }
                ...
                >
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    <div>
                      ...
                      <Input
                        ...
                        className={
                          addressErrors.firstName ? "border-red-300" : ""
                        }
                      />
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={
                          addressErrors.lastName ? "border-red-300" : ""
                        }
                      />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={
                        addressErrors.streetAddress1 ? "border-red-300" : ""
                      }
                    />
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <Input
                        ...
                        className={
                          addressErrors.countryArea ? "border-red-300" : ""
                        }
                      />
                  ...
                  <div>
                    ...
                    <Input
                      ...
                      className={
                        addressErrors.postalCode ? "border-red-300" : ""
                      }
                    />
                  ...
                  <Button
                    type="submit"
                    size="lg"
                    className="w-full bg-[#CF00FF] hover:bg-[#B800E6] text-white py-4"
                  >
                    Continue to Payment
                  </Button>
                </form>
                ...
                >
                  ...
                  <div className="flex space-x-4">
                    ...
                    <Button
                      type="submit"
                      size="lg"
                      className="flex-1 bg-[#CF00FF] hover:bg-[#B800E6] text-white"
                    >
                      Complete Order
                    </Button>
                  </div>
